class TextConstant {
  ...
  static String createPermit = "Create Permit";
  static String permitName = "Permit Name";
  static String description = "Description";
  static String addPermit = "Add Permit";
  static String future = "Future";
  static String current = "Current";
  static String expired = "Expired";
  static String user = "User";
  static String permitDate = "Permit Date";
  static String permitFrom = "Permit From";
  static String permitTo = "Permit To";
  static String requestedBy = "Requested By";
  static String triggeredAt = "Triggered At";
